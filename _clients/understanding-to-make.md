...
Aside: since our task walkthrough not only shows how our design supports each of our tasks, but also clearly conveys screen transitions, we will leave out the overview of screens from this section. However, the complete contents of our digital mockup deliverable can be found [here](https://londonmeanswild.github.io/museum-experience/2018/11/12/digital-mock-up/). Additionally, our walkthrough will be very similar to final prototype one above in order to show the consistency between the designs.
